...
PRODUCT_COPY_FILES +=  \
    ...
    vendor/osr/prebuilt/drm/lib/libfrsdk.so:system/lib/libfrsdk.so \
    vendor/osr/prebuilt/drm/lib/libgcomm_jni.so:system/lib/libgcomm_jni.so \
    vendor/osr/prebuilt/drm/lib/libWVphoneAPI.so:system/lib/libWVphoneAPI.so \
